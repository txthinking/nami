...
cp(`https://github.com/txthinking/bash/releases/latest/download/monitor_${nami.os}_${nami.arch}${nami.os == "windows" ? '.exe' : ''}`, `${nami.cache_dir}/monitor${nami.os == "windows" ? '.exe' : ''}`)
