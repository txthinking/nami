...
if(Deno.build.os == "darwin" && Deno.build.arch == "x86_64"){
    await n.download_commands_from_tgz_url(`https://github.com/Code-Hex/Neo-cowsay/releases/latest/download/cowsay_${j.tag_name.replace("v","")}_macOS_x86_64.tar.gz`, {
        'cowsay': 'cowsay',
        'cowthink': 'cowthink',
    });
    Deno.exit(0);
