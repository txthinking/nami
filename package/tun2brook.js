...
if (Deno.build.os == "darwin" && Deno.build.arch == "aarch64") {
    await n.download_command_from_url("https://github.com/txthinking/tun2brook/releases/latest/download/tun2brook_darwin_arm64", "tun2brook");
    Deno.exit(0);
}
if (Deno.build.os == "darwin" && Deno.build.arch == "x86_64") {
    await n.download_command_from_url("https://github.com/txthinking/tun2brook/releases/latest/download/tun2brook_darwin_amd64", "tun2brook");
    Deno.exit(0);
}
if (Deno.build.os == "linux" && Deno.build.arch == "x86_64") {
    await n.download_command_from_url("https://github.com/txthinking/tun2brook/releases/latest/download/tun2brook_linux_amd64", "tun2brook");
    Deno.exit(0);
}
if (Deno.build.os == "windows" && Deno.build.arch == "x86_64") {
    await n.download_command_from_url("https://github.com/txthinking/tun2brook/releases/latest/download/tun2brook_windows_amd64.exe", "tun2brook.exe");
    try{
